...
class Axis( NodePath ):
    ...
    def AddGeometry( self, geom, pos=Point3(0, 0, 0), colour=None, highlight=True, sizeStyle=TRANSLATE ):
    ...
    def AddCollisionSolid( self, collSolid, pos=Point3(0, 0, 0), sizeStyle=TRANSLATE ):
