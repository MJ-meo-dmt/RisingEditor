...
class Mouse( DirectObject ):
    ...
    def __init__( self ):
        ...
        self.accept( 'alt-mouse1', self.SetButton, [0, True, [MOUSE_ALT]] )
        self.accept( 'mouse1-up', self.SetButton, [0, False, []] )
        
        self.accept( 'alt-mouse2', self.SetButton, [1, True, [MOUSE_ALT]] )
        self.accept( 'mouse2', self.SetButton, [1, True] )
        self.accept( 'mouse2-up', self.SetButton, [1, False, []] )
        
        self.accept( 'alt-mouse3', self.SetButton, [2, True, [MOUSE_ALT]] )
